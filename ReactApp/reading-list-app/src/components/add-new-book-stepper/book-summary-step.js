...
export default function BookSummaryStep(props) {
  ...
  useEffect(() => {
    async function getAuthor() {
      const author = await _authorService.getAuthorByIdFromApi(
  ...
  return (
    <Box>
      ...
      <Typography className="step-description" variant="body2">
        Check the information about the record you are creating. If you need to
        change anything, go back and change the value. If the data is correct, click the Add button at the bottom left of the
        form.
      </Typography>
    </Box>
  );
